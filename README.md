...
This project is a basic app with a background video and sliding menu bar.

Feel free to look at my projects. If you want to drop a line visit my personal [website](http://davidsoto.dev/).

## Launch

To see the project live tap [here](https://daviddadev.github.io/background-video-with-slide-menu/index.html), and thanks for visiting my GitHub. Enjoy.
